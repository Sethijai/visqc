...
async def Handle_StartMsg(bot:Client, msg:Message):
    ...
    if msg.chat.type == enums.ChatType.SUPERGROUP and not await db.is_user_exist(msg.from_user.id):
        ...
        btn = [
            ...
            [InlineKeyboardButton(text='💻 Dᴇᴠᴇʟᴏᴘᴇʀ', url='https://t.me/talkwithHackheist_bot')]
        ]
        ...
        btn = [
            ...
            [InlineKeyboardButton(text='📢 Uᴘᴅᴀᴛᴇs', url='https://t.me/Opmasterlectures'), InlineKeyboardButton(text='💻 DEVELOPER', url='https://t.me/Real_Hackheist')]
        ]
...
async def Files_Option(bot:Client, message:Message):
    ...
    try:
        ...
        buttons = [[InlineKeyboardButton("Cᴏᴍᴘʀᴇss / Reduce size 🗜️", callback_data=f"compress-{message.from_user.id}")]]
